...
// REFACTORED CODE
let sumAndProduct2 = (a, b) => {return [a + b, a * b]};
...
// REFACTORED CODE
let messageRefactored = name => `Hello, ${name}!`;
...
// let joe = new Student2('Joe', 'Schmoe', 100);
...
// -----> Cannot use arrow function & 'this'  - 'this' bubbles up to the window object and no longer refers to the constructor function. To get the code working again, code just needs to be returned to the original code block.
